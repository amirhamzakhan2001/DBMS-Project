...
// Define the paths for photos directory
  ...
  async (req, res) => {
    try {
      const {
        ...
        floor_number, description, video_tour, landlord_name, 
      ...
      const query = `
        ...
        number_of_bedrooms, number_of_bathrooms, number_of_balconies, year_built, 
        property_condition, parking_spaces, amenities, furnished, utilities_included, 
        floor_number, description, photos, video_tour, landlord_name, 
        contact_number, email_address, preferred_contact, additional_notes, client_id)
